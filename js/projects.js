...
/* 1ページに表示する作品数。
 * ページ数は作品数に応じて自動で増えます（作品96件なら16ページ）。
 * 上限はないので、各カテゴリに20ページ分(120作品)以上入れても大丈夫です */
...
const PROJECTS = [
  ...
  },
  {
    ...
    description: "CPUと対戦できる1人用の花札(こいこい)。強さは弱・中・強の3段階に加え、小学生でもわかる「チュートリアル(れんしゅう)」モードを搭載。花子先生と一緒に実際にプレイしながら大事な場面でアドバイスがもらえます。役の一覧やこいこいのルールを解説する「ルール説明」ページ付き。スマホ・タブレット・iPad対応。",
    url: "apps/hanafuda/index.html",
    category: "webapp",
    tags: ["HTML", "CSS", "JavaScript"],
    emoji: "🌸",
    date: "2026.07",
  ...
  {
    title: "トランプパーティー — 4種のカードゲーム集",
    description: "ポーカー・ブラックジャック・大富豪・神経衰弱の4モードが遊べるトランプゲーム集。すべて初級/中級/上級の3段階でCPUと対戦できます。トランプ柄をたくさん使った賑やかなデザインでスマホ・タブレット・iPad対応。",
    url: "apps/trump-games/index.html",
    category: "webapp",
    tags: ["HTML", "CSS", "JavaScript"],
    emoji: "🃏",
    date: "2026.07",
  },
  // CODE DOJOは非公開(自分専用リンクのみでアクセス)のため一覧から除外。
  // 直接URL: works/code-dojo-b16f2cfa6e/index.html
  {
    title: "一筆書きコインズ — レトロ一筆書きタップパズル",
    description: "スタートからゴールまで、壁の見える迷路を自分で考えてたどるレトロ昭和・平成風の一筆書きタップパズル。全40ステージを毎回ランダム自動生成し、じっくり攻略できる通常モードと、ランキング付きのタイムアタックモードの2種類で遊べます。",
    url: "apps/hitofude-coins/index.html",
    category: "webapp",
    tags: ["HTML", "CSS", "JavaScript"],
    emoji: "🪙",
    date: "2026.07",
  ...
  {
    title: "大和屋酒店 — 創業明治十二年の老舗酒類通販サイト",
    description: "ウイスキー・ビール・ワイン・日本酒・焼酎・ウォッカ・ジン・ラム・テキーラ・シャンパン・梅酒まで、山崎やラフロイグ、フランス/チリ/イタリア産ワインなど有名銘柄82品を実写画像つきで紹介する架空の老舗酒店ECサイト。カートは追加・数量変更・削除が自由で、注文ボタンはデモアラート表示。年齢確認ゲートやお客様の声も収録し、スマホ・タブレット対応。",
    url: "works/sake-shop/index.html",
    category: "website",
    tags: ["HTML", "CSS", "JavaScript"],
    emoji: "🍶",
